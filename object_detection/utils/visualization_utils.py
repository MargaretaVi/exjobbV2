...
def draw_bounding_box_on_image(image,
  ...
  try:
   font = ImageFont.truetype('/usr/share/fonts/truetype/freefont/FreeMonoBoldOblique', 14)
  except IOError:
...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  for box, color in box_to_color_map.items():
    ...
    if object_to_find != 'ALL':
      pattern = r"^(.*):"
      string = box_to_display_str_map[box][0]
      name = re.match(pattern,string).group(1)
      if (name != object_to_find):  
        continue
